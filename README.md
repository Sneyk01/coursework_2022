...
## Используемые технологии
 ...
 ## Ход работы 
  ...
  При добавлении записи о госте через telegram бота или панель администратора, происходит проверка автомобильного номера на совпадение с регулярным выражением. Допускаются только автомобильные номера вида: х000хх. Так же справа от номера может быть указан регион.
...
| **time** | int | 11 | NO | Время создания токена |
 ...
 Таблица жителей будет содержать в себе имя и фамилию жильца, номер его автомобиля и дома, id пользователя, id телеграмм аккаунта и пригласительный ключ. Если у жителя несколько автомобилей, то они будут указаны в поле через точку с запятой. Структура таблицы жителей и пример записи в ней:
   | Название | Тип | Длина | По умолчанию | Описание |
| :------: | :------: | :------: | :------: | :------: |
